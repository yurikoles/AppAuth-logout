![AppAuth for iOS and macOS](./appauth_lockup.svg)
[![Build Status](https://travis-ci.com/yurikoles/AppAuth-logout.svg?branch=master)](https://travis-ci.com/yurikoles/AppAuth-logout)
